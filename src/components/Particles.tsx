...
function hexToRgb(hex: string): number[] {
  ...
  const hexInt = parseInt(clean, 16);
...
export function Particles({
  ...
  ease = 50,
  size = 1.5,
  colors = ['#4D96FF', '#FF6EC7', '#FFD93D', '#6BCB77'],
  vx = 0,
  vy = 0,
}: ParticlesProps) {
  ...
  const circleParams = (): Circle => {
    ...
    return { x, y, translateX: 0, translateY: 0, size: pSize, alpha: 0, targetAlpha, dx, dy, magnetism, rgb };
  };
